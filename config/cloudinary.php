...
return [
    ...
    */
    ...
    'cloud_url' => env('CLOUDINARY_URL') ?: 'cloudinary://' . env('CLOUDINARY_KEY', '923616598195967') . ':' . env('CLOUDINARY_SECRET', 'sNMluL2MGxSCQSKkNFi7ZuSRgsw') . '@' . env('CLOUDINARY_CLOUD_NAME', 'dw259hnd9'),
    /**
